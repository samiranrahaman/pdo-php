...
//echo "ddd: ".$MAINPAGE;
    ...
    $result = $db->getRows('projects',array('order_by'=>'id DESC'));
     ...
     //  $RoleName = $db->getRows('Role',array('where'=>array('RoleId'=>$res["RoleId"]),'return_type'=>'single'));
	   ...
	   if(!$AdminUserU['UserName']=='Admin'){
        ...
        <tr>
			...
			?>
			<td colspan="5">
			 <a href="<?php echo $baseurls->url;?>modules/AccountsManagment/project/editpage?id=<?php echo $res['Id'] ?>" class="btncon"><i class="fa fa-eye"></i></a>
