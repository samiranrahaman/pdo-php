...
<?php
$id = $_GET['id'];
$result = $db->getRows('projects',array('where'=>array('Id'=>$id),'return_type'=>'single'));
if(!empty($result)){ 
?>
...
<div class="col-sm-9">
 <input type="text" name="projectname" id="projectname" value="<?php echo $result['ProjectName']; ?>" class="form-control" required="required">
</div>
</div>   
<div class="form-group">
<label for="inputPassword3" class="col-sm-3 control-label">Project Budget</label>
<div class="col-sm-9">
 <input type="text" name="ProjectBudget" id="ProjectBudget" value="<?php echo $result['ProjectBudget']; ?>" class="form-control" required="required">
</div>
</div> 
...
<div class="col-sm-9">
 <input type="text" name="ProjectDetails" id="ProjectDetails" value="<?php echo $result['ProjectDetails']; ?>" class="form-control" required="required">
 <input type="hidden" name="autoid" id="autoid" value="<?php echo $result['Id']; ?>" class="form-control" required="required">
</div>
</div> 
<div class="form-group">
<label for="inputPassword3" class="col-sm-3 control-label">Project Links</label>
<div class="col-sm-9">
 <input type="text" name="ProjectLink1" id="ProjectLink1" value="<?php echo $result['ProjectLink1']; ?>" class="form-control" required="required">
</div>
</div> 
...
<div class="col-sm-9">
 <input type="text" name="ProjectResponsiblePerson" id="ProjectResponsiblePerson" value="<?php echo $result['ProjectResponsiblePerson']; ?>" class="form-control" required="required">
</div>
</div> 
<div class="form-group">
<label for="Expenses" class="col-sm-3 control-label">Account Details</label>
<div class="col-sm-9">
<textarea name="account_details" id="account_details" class="form-control account_details"><?php echo $result['ProjectAccountDetails']; ?></textarea>
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-3 control-label">Name</label>
<div class="col-sm-9">
 <input type="text" name="name" id="name" value="<?php echo $result['Name']; ?>" class="form-control" required="required">
</div>
</div>  
...
<div class="col-sm-9">
 <input type="text" name="occupation" id="occupation" class="form-control" value="<?php echo $result['Occupation']; ?>" required="required">
</div>
</div>
...
<div class="col-sm-9">
 <input type="text" name="phone1" id="phone1" class="form-control" value="<?php echo $result['PhoneNumber']; ?>" required="required">
</div>
</div>
<div class="form-group">
<label for="Occupation" class="col-sm-3 control-label">Email</label>
<div class="col-sm-9">
 <input type="text" name="email" id="email" class="form-control" value="<?php echo $result['Email']; ?>" required="required">
</div>
</div>       
...
<div class="col-sm-9">
    <textarea name="address" id="address" class="form-control address" required="required"><?php echo $result['ProjectAddress']; ?></textarea>
</div>
</div> 
...
<?php
$VendorCountry = $result['ProjectCountry'];

$countryresult = $db->getRows('country',array('where'=>array('CountryId'=>$VendorCountry),'return_type'=>'single'));


 echo '<option value="'.$result['ProjectCountry'].'">'.$countryresult['CountryName'].'</option>';
...
$BeneficiaryStateId = $result['ProjectState'];
$stateresult = $db->getRows('state',array('where'=>array('StateId'=>$BeneficiaryStateId),'return_type'=>'single'));



 echo '<option value="'.$result['ProjectState'].'">'.$stateresult['StateName'].'</option>';
...
<div class="col-sm-9">
				...
				<?php
	$BeneficiaryCityId = $result['ProjectCity'];
    $cityresult = $db->getRows('city',array('where'=>array('CityId'=>$BeneficiaryCityId),'return_type'=>'single'));

  echo '<option value="'.$result['ProjectCity'].'">'.$cityresult['CityName'].'</option>';				
...
<div class="col-sm-9">
   <input type="text" name="landmark" id="landmark" class="form-control" value="<?php echo $result['ProjectLandMark']; ?>" required="required">
</div>
</div> 
...
<div class="col-sm-9">
    <textarea name="remarks" id="remarks"  class="form-control"><?php echo $result['ProjectRemarks']; ?></textarea>
</div>
</div>  
				<div class="form-group">
				<div class="col-sm-3">
