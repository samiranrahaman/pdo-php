...
<div class="col-sm-9">
 <input type="text" name="vendor_id" id="vendor_id" value="" class="form-control" required="required">
</div>
</div> 
<div class="form-group">
