...
//echo "ddd: ".$MAINPAGE;
    ...
    $result = $db->getRows('vendor',array('order_by'=>'id DESC'));
	 ...
	 //  $BranchName = $db->getRows('BranchLocation',array('where'=>array('BranchId'=>$res["BranchId"]),'return_type'=>'single'));
	   ...
	   if(!$AdminUserU['UserName']=='Admin'){
        ...
        <tr>
			...
			?>
			<td colspan="5">
			 <a href="<?php echo $baseurls->url;?>modules/AccountsManagment/Vendor/editpage?id=<?php echo $res['Id'] ?>" class="btncon"><i class="fa fa-eye"></i></a>
			 
			
			
			  <a href="#" class="del btncon" id="<?php echo $res["Id"] ?>" style="margn-right: 5px;">
