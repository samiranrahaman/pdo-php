            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Country Name</label>
                        <input type="text"  name="CountryName" id="CountryName" placeholder="Country Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { CountryName: CountryName, action_type : action_type},
        //processData: false,
        //contentType: false,
