...
$id = $_POST['id'];
	...
	$result = $db->getRows('Religion',array('where'=>array('ReligionId'=>$id),'return_type'=>'single'));
	...
	if(!empty($result)){ 
        ...
        <div class="form-group col-lg-3">
            ...
            <label>Religion Name</label><br/>
				<input type="text" style="width: 90%;" name="UReligionName" id="UReligionName" value="<?php echo $result['ReligionName']; ?>" class="form-control" required />
			</div>
			
			<div class="form-group col-lg-3">
            <input type="text" id='uaction_type' name="uaction_type" value="edit" hidden/> 
            <label>Action</label><br/>
			<button type="button" class="btn btn-primary update" id="<?php echo $result['ReligionId']; ?>" name="update">Update Record</button>
...
<script type="text/javascript">
	$('.update').click(function() {
		var id = $(this).attr('id');
        var UReligionName = $('#UReligionName').val();
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, UReligionName : UReligionName, action_type: action_type },
