...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Religion Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Religion Name</label>
                        <input type="text"  name="ReligionName" id="ReligionName" placeholder="Religion Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { ReligionName: ReligionName, action_type : action_type},
        //processData: false,
        //contentType: false,
