...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">City Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>City Name</label>
                        <input type="text"  name="CityName" id="CityName" placeholder="City Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { CityName : CityName, CountryId : CountryId, StateId : StateId, action_type : action_type},
        //processData: false,
        //contentType: false,
