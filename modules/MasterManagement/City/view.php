...
include_once $serverRoot.'/SBM/includes/logics/Crud.php';
    ...
    $result = $db->getRows('City',array('order_by'=>'CityId DESC'));
    ...
    <?php
	   ...
	   $StateName = $db->getRows('State',array('where'=>array('StateId'=>$res["StateId"]),'return_type'=>'single'));
        ...
        <tr>
            ...
            <td>'.$res["UpdatedBy"].'</td>
            <td>'.$res["IsActive"].'</td>
			<td><button id="'.$res["CityId"].'" class="edit btn btn-info">Edit</button> <button class="del btn btn-danger" id="'.$res["CityId"].'">Delete</button></td>
		</tr>';
	}
}else{ ?>
