            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Payment Type Name</label>
                        <input type="text"  name="PaymentTypeName" id="PaymentTypeName" placeholder="Payment Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { PaymentTypeName: PaymentTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
