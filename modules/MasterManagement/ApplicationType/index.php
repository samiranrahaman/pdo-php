...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Application Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Application Type Name</label>
                        <input type="text"  name="ApplicationTypeName" id="ApplicationTypeName" placeholder="Application Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var ApplicationTypeName = $('#ApplicationTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { ApplicationTypeName: ApplicationTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
