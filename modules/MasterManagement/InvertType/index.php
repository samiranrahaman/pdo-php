...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Invert Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Invert Type Name</label>
                        <input type="text"  name="InvertTypeName" id="InvertTypeName" placeholder="Invert Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var InvertTypeName = $('#InvertTypeName').val();
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { InvertTypeName: InvertTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
