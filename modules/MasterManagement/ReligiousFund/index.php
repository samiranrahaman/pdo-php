...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Religious Fund Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Religious Fund Type Name</label>
                        <input type="text"  name="ReligiousFundTypeName" id="ReligiousFundTypeName" placeholder="Religious Fund Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var ReligiousFundTypeName = $('#ReligiousFundTypeName').val();
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { ReligiousFundTypeName: ReligiousFundTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#ReligiousFundTypeName').val('');
           // alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
