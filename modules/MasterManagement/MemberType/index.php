            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Member Type Name</label>
                        <input type="text"  name="MemberTypeName" id="MemberTypeName" placeholder="Member Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { MemberTypeName: MemberTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
