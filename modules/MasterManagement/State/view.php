...
include_once $serverRoot.'/SBM/includes/logics/Crud.php';
    ...
    $result = $db->getRows('State',array('order_by'=>'StateId DESC'));
    ...
    <?php
       $CountryName = $db->getRows('Country',array('where'=>array('CountryId'=>$res["CountryId"]),'return_type'=>'single'));
        ...
        <tr>
            ...
            <td>'.$res["UpdatedBy"].'</td>
            <td>'.$res["IsActive"].'</td>
			<td><button id="'.$res["StateId"].'" class="edit btn btn-info">Edit</button> <button class="del btn btn-danger" id="'.$res["StateId"].'">Delete</button></td>
		</tr>';
	}
}else{ ?>
