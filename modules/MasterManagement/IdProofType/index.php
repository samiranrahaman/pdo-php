...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">IdProof Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>IdProof Type Name</label>
                        <input type="text"  name="IdProofTypeName" id="IdProofTypeName" placeholder="IdProof Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var IdProofTypeName = $('#IdProofTypeName').val();
   ...
   // alert(CountryName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { IdProofTypeName: IdProofTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
