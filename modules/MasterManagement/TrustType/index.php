...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Trust Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Trust Type Name</label>
                        <input type="text"  name="TrustTypeName" id="TrustTypeName" placeholder="Trust Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var TrustTypeName = $('#TrustTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { TrustTypeName: TrustTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
