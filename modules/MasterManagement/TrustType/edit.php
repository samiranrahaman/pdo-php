...
$id = $_POST['id'];
	...
	$result = $db->getRows('TrustType',array('where'=>array('TrustTypeId'=>$id),'return_type'=>'single'));
	...
	if(!empty($result)){ 
        ...
        <div class="form-group col-lg-3">
            ...
            <label>Trust Type Name</label><br/>
				<input type="text" style="width: 90%;" name="UTrustTypeName" id="UTrustTypeName" value="<?php echo $result['TrustTypeName']; ?>" class="form-control" required />
			</div>
			
			<div class="form-group col-lg-3">
            <input type="text" id='uaction_type' name="uaction_type" value="edit" hidden/> 
            <label>Action</label><br/>
			<button type="button" class="btn btn-primary update" id="<?php echo $result['TrustTypeId']; ?>" name="update">Update Record</button>
...
<script type="text/javascript">
	$('.update').click(function() {
		var id = $(this).attr('id');
        var UTrustTypeName = $('#UTrustTypeName').val();
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, UTrustTypeName : UTrustTypeName, action_type: action_type },
