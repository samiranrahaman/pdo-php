...
session_start();
// Check to see if the session user SMS exists.
...
$BranchName = $db->getRows('SMSSettings',array('order_by'=>'SMSSettingsId DESC'));

?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">SMS Settings Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="pull-right">
                    <button class="btn btn-success" id="show-add">Add New SMS Settings</button>
                </div>
                ...
                <label>SMS From</label>
                        <input type="number"  name="SMSFrom" id="SMSFrom" placeholder="SMS From" class="form-control" required />
                    ...
                    <label>Action</label><br/>
                        <button type="button" class="btn btn-primary" id="add" name="add">Add SMS Settings</button>
...
$('#add').click(function() {
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { MailServer:MailServer,SMSFrom:SMSFrom,UserName:UserName,Password:Password,Port:Port, action_type : action_type},
        //processData: false,
        //contentType: false,
