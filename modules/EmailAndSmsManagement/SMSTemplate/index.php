...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">SMS Template Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="pull-right">
                    <button class="btn btn-success" id="show-add">Add New SMS Template</button>
                </div>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>SMS Template  Name</label>
                        <input type="text"  name="SMSTemplateName" id="SMSTemplateName" placeholder="SMSTemplate Name" class="form-control" required />
                   
                 
                    <label>SMS Subject</label>
                        <input type="text"  name="SMSTemplateSubject" id="SMSTemplateSubject" placeholder="SMS Subject" class="form-control" required />
            ...
            <div class="box-body pad">
              <form>
                    <textarea name="SMSTemplateDescription" id="SMSTemplateDescription" rows="10" cols="80">
                    ...
                    <label>Action</label><br/>
                        <button type="button" class="btn btn-primary" id="add" name="add">Add SMS Template</button>
...
$('#add').click(function() {
    ...
    var SMSTemplateSubject = $('#SMSTemplateSubject').val();
   // var SMSTemplateDescription = $('#SMSTemplateDescription').val();
    var SMSTemplateDescription = CKEDITOR.instances["SMSTemplateDescription"].getData();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { SMSTemplateName:SMSTemplateName,SMSTemplateSubject:SMSTemplateSubject,SMSTemplateDescription:SMSTemplateDescription, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            ...
            $('#SMSTemplateSubject').val('');
            //$('#SMSTemplateDescription').val('');
            CKEDITOR.instances["SMSTemplateDescription"].setData("");
           //$("#BranchName").val();
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
...
$(function () {
   ...
   /* $('.select2').on('change', function() {
    ...
    CKEDITOR.replace('SMSTemplateDescription')
