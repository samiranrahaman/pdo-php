        ...
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="pull-right">
                    <button class="btn btn-success" id="show-add">Add New Module</button>
                </div>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Module Title</label>
                        <input type="text"  name="ModuleTitle" id="ModuleTitle" placeholder="Module Title" class="form-control" required />
                    ...
                    <label>Action</label><br/>
                        <button type="button" class="btn btn-primary" id="add" name="add">Add Module</button>
...
$('#add').click(function() {
   ...
   // alert(ModuleName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { ModuleTitle: ModuleTitle,Description:Description, action_type : action_type},
        //processData: false,
        //contentType: false,
