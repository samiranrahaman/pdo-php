...
$id = $_POST['id'];
	...
	$result = $db->getRows('Module',array('where'=>array('ModuleId'=>$id),'return_type'=>'single'));
	...
	if(!empty($result)){ 
        ...
        <div class="form-group col-lg-3">
            ...
            <label>Module Title</label><br/>
				<input type="text" style="width: 90%;" name="uModuleTitle" id="uModuleTitle" value="<?php echo $result['ModuleTitle']; ?>" class="form-control" required />
			...
			<button type="button" class="btn btn-primary update" id="<?php echo $result['ModuleId']; ?>" name="update">Update Module</button>
...
<script type="text/javascript">
	$('.update').click(function() {
		var id = $(this).attr('id');
        var ModuleTitle = $('#uModuleTitle').val();
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, ModuleTitle: ModuleTitle,Description:Description, action_type: action_type },
