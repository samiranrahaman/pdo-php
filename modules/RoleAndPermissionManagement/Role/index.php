        ...
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="pull-right">
                    <button class="btn btn-success" id="show-add">Add New Role</button>
                </div>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Role Name</label>
                        <input type="text"  name="RoleName" id="RoleName" placeholder="Role Name" class="form-control" required />
                    ...
                    <label>Action</label><br/>
                        <button type="button" class="btn btn-primary" id="add" name="add">Add Role</button>
...
$('#add').click(function() {
   ...
   // alert(RoleName);
    ...
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { RoleName: RoleName,Description:Description, action_type : action_type},
        //processData: false,
        //contentType: false,
