...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Relationship Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Relationship Name</label>
                        <input type="text"  name="RelationshipName" id="RelationshipName" placeholder="Relationship Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var RelationshipName = $('#RelationshipName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { RelationshipName: RelationshipName, action_type : action_type},
        //processData: false,
        //contentType: false,
