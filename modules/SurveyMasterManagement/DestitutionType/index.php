...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">DistitutionT ype Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Distitution Type Name</label>
                        <input type="text"  name="DistitutionTypeName" id="DistitutionTypeName" placeholder="Distitution Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var DistitutionTypeName = $('#DistitutionTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { DistitutionTypeName: DistitutionTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#DistitutionTypeName').val('');
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
