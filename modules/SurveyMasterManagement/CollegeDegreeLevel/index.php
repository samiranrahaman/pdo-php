...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">College Degree Level Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>College Degree Level Name</label>
                        <input type="text"  name="CollegeDegreeLevelName" id="CollegeDegreeLevelName" placeholder="College Degree Level Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var CollegeDegreeLevelName = $('#CollegeDegreeLevelName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { CollegeDegreeLevelName: CollegeDegreeLevelName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#CollegeDegreeLevelName').val('');
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
