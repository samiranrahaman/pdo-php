...
include_once $serverRoot.'/SBM/includes/logics/Crud.php';
    ...
    $result = $db->getRows('SurveyConclusionQuestion',array('order_by'=>'SurveyConclusionQuestionId DESC'));
	...
	?>
			...
			<tr>
			<th>SL</th>
			<th>Survey Conclusion Question Name</th>
			<th>Option1</th>
			<th>Option2</th>
			<th>Option3</th>
			<th>Option4</th>
...
if(!empty($result)){ $count = 0; foreach($result as $res){ $count++;?>
    <?php
        ...
        <tr>
			...
			<td>'.$res["SurveyConclusionQuestionName"].'</td>
			<td>'.$res["option1"].'</td>
			<td>'.$res["option2"].'</td>
			<td>'.$res["option3"].'</td>
			<td>'.$res["option4"].'</td>
            ...
            <td>'.$res["UpdatedBy"].'</td>
            <td>'.$res["IsActive"].'</td>
			<td><button id="'.$res["SurveyConclusionQuestionId"].'" class="edit btn btn-info">Edit</button> <button class="del btn btn-danger" id="'.$res["SurveyConclusionQuestionId"].'">Delete</button></td>
		</tr>';
	}
}else{ ?>
