...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">House Type Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>House Type Name</label>
                        <input type="text"  name="HouseTypeName" id="HouseTypeName" placeholder="House Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var HouseTypeName = $('#HouseTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { HouseTypeName: HouseTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
