...
$id = $_POST['id'];
	...
	$result = $db->getRows('HouseType',array('where'=>array('HouseTypeId'=>$id),'return_type'=>'single'));
	...
	if(!empty($result)){ 
        ...
        <div class="form-group col-lg-3">
            ...
            <label>Work Type Name</label><br/>
				<input type="text" style="width: 90%;" name="UHouseTypeName" id="UHouseTypeName" value="<?php echo $result['HouseTypeName']; ?>" class="form-control" required />
			</div>
			
			<div class="form-group col-lg-3">
            <input type="text" id='uaction_type' name="uaction_type" value="edit" hidden/> 
            <label>Action</label><br/>
			<button type="button" class="btn btn-primary update" id="<?php echo $result['HouseTypeId']; ?>" name="update">Update Record</button>
...
<script type="text/javascript">
	$('.update').click(function() {
		var id = $(this).attr('id');
        var UHouseTypeName = $('#UHouseTypeName').val();
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, UHouseTypeName : UHouseTypeName, action_type: action_type },
