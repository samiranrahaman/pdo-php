...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">University Type Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>University Type Name</label>
                        <input type="text"  name="UniversityTypeName" id="UniversityTypeName" placeholder="University Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var UniversityTypeName = $('#UniversityTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { UniversityTypeName: UniversityTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#UniversityTypeName').val('');
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
