...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">College Type Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>College Type Name</label>
                        <input type="text"  name="CollegeTypeName" id="CollegeTypeName" placeholder="College Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var CollegeTypeName = $('#CollegeTypeName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { CollegeTypeName: CollegeTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
