...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Work Type Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Work Type Name</label>
                        <input type="text"  name="WorkTypeName" id="WorkTypeName" placeholder="Work Type Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { WorkTypeName: WorkTypeName, action_type : action_type},
        //processData: false,
        //contentType: false,
