...
$id = $_POST['id'];
	...
	$result = $db->getRows('WorkType',array('where'=>array('WorkTypeId'=>$id),'return_type'=>'single'));
	...
	if(!empty($result)){ 
        ...
        <div class="form-group col-lg-3">
            ...
            <label>Work Type Name</label><br/>
				<input type="text" style="width: 90%;" name="UWorkTypeName" id="UWorkTypeName" value="<?php echo $result['WorkTypeName']; ?>" class="form-control" required />
			</div>
			
			<div class="form-group col-lg-3">
            <input type="text" id='uaction_type' name="uaction_type" value="edit" hidden/> 
            <label>Action</label><br/>
			<button type="button" class="btn btn-primary update" id="<?php echo $result['WorkTypeId']; ?>" name="update">Update Record</button>
...
<script type="text/javascript">
	$('.update').click(function() {
		var id = $(this).attr('id');
        var UWorkTypeName = $('#UWorkTypeName').val();
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, UWorkTypeName : UWorkTypeName, action_type: action_type },
