...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">Survey Conclusion Category Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>Survey Conclusion Category Name</label>
                        <input type="text"  name="SurveyConclusionCategoryName" id="SurveyConclusionCategoryName" placeholder="Survey Conclusion Category Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var SurveyConclusionCategoryName = $('#SurveyConclusionCategoryName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { SurveyConclusionCategoryName: SurveyConclusionCategoryName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#SurveyConclusionCategoryName').val('');
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
