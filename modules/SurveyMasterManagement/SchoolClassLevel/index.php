...
?>
 <div class="container-fluid" style="padding: 0px; margin: 0px;">
        <div class="">
            <h1 class="text-center">School Class Level Management </h1>
        </div>
    </div>
    <div class="container" >
        <div class="row">
            ...
            <div id="link-update" >
                ...
                <div class="form-group col-lg-3">
                    ...
                    <label>School Class Level Name</label>
                        <input type="text"  name="SchoolClassLevelName" id="SchoolClassLevelName" placeholder="School Class Level Name" class="form-control" required />
                    </div>
...
$('#add').click(function() {
    var SchoolClassLevelName = $('#SchoolClassLevelName').val();
   ...
   // console.log(PaymentTypeName);
    $.ajax({
        url: "add.php",
        type: "POST",
        data: { SchoolClassLevelName: SchoolClassLevelName, action_type : action_type},
        //processData: false,
        //contentType: false,
        success: function(data, status, xhr) {
           // alert(data);
            $('#SchoolClassLevelName').val('');
            //alert(data);
           if(data == 'success'){
                $.get("view.php", function(data) {
                        $("#table_content").html(data);
