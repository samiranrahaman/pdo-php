...
$state = $db->getRows('state',array('where'=>array('CountryId'=>$DonorCountryId),'order_by'=>'StateId DESC'));
?>
...
<script>
	...
	//alert(DonorStateId);
	 ...
	 $.ajax({
        url: "city.php",
        type: "POST",
        data: { DonorCountryId : DonorCountryId,DonorStateId:DonorStateId},

        success: function(data, status, xhr) {

          
                $('#DonorCityId').html(data);
