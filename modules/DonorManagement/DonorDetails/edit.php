        ...
        <div class="form-group col-lg-3">
                ...
                <label>Employee Name</label>
                    ...
                    <label>Branch Type</label>
                        ...
                        <input type="text"  name="uPassword" id="uPassword" value="<?php echo  $result['Password'];?>" class="form-control" required />
                        <br/>
			...
			<button type="button" class="btn btn-primary update" id="<?php echo $result['BranchId']; ?>" name="update">Update Employee</button>
	...
	$('.update').click(function() {
      ...
      //  var BranchLogoImageUrl = $('#upreview').attr('src');
        ...
        $.ajax({
            url: "update.php",
            type: "POST",
            data: { id: id, EmployeeName : EmployeeName, RoleId : RoleId,BranchId:BranchId,UserName:UserName,Password:Password,EmployeeImageUrl:EmployeeImageUrl, action_type : action_type },
